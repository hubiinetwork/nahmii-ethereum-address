...
describe('EthereumAddress', () => {
    ...
    function verifyEthereumAddressInstance() {
        ...
        it('is an EthereumAddress instance', () => {
            assert.doesNotThrow(() => EthereumAddress.assertInstance(address));
        });
    }
    ...
    context('a string', () => {
        it('is it not an EthereumAdddress instance', () => {
            const str = '0x0011223344556677889900112233445566778899';
            assert.throws(() => EthereumAddress.assertInstance(str), TypeError);
        });
    });
});
